                        ...
                        <form action="{{ route('leave-applications.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-lg-4 o-f-inp mb-3">
                                    ...
                                    <input type="text" name="application_no" class="form-control shadow-none" value="{{ $applicationNo }}" readonly>
                                </div>
                                <div class="col-lg-4 o-f-inp mb-3">
                                    <label for="">Applied Date <span class="text-danger">*</span></label>
                                    <input type="date" name="applied_date"  value="{{ $appliedDate }}" class="form-control shadow-none" readonly>
                                </div>
                                <div class="col-lg-4 o-f-inp mb-3">
                                    <label>Teacher </label>
                                ...
                                <div class="col-lg-4 o-f-inp mb-3">
                                    ...
                                    <input type="date" name="from_date" id="from_date" class="form-control shadow-none">
                                </div>
                                <div class="col-lg-4 o-f-inp mb-3">
                                    <label for="">To Date <span class="text-danger">*</span></label>
                                    <input type="date" name="to_date" id="to_date" class="form-control shadow-none">
                                </div>
                                <div class="col-lg-4 o-f-inp mb-3">
                                    <label for="">Total Days <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control shadow-none" id="days">
                                </div>
                                <div class="col-lg-4 o-f-inp mb-3">
                                    <label for="">Reason<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control shadow-none" name="reason">
                                </div>
