            ...
            <div class="row">
              ...
              <div class="col-lg-3 mb-3">
                <div class="o-f-inp">
                  ...
                  <select id="venue_type_filter" class="form-select shadow-none">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="btn-flex">
              ...
              @can('create.venue')
                <a href="{{ route('venues.create') }}" class="add-btn">Add New</a>
              @endcan
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-12">
            <div class="mt-3 table-container">
              <div class="row justify-content-end">
                <div class="col-lg-5">
                  <div class="entry-select">
                    <p>Showing</p>
                    <select id="venuePerPage" class="form-select shadow-none">
                ...
                <div class="col-lg-7">
                  <div class="table-search">
                    <label for="venueTableSearch" class="nowrap">Search</label>
                    <input type="text" id="venueTableSearch" class="form-control shadow-none"
                      placeholder="Search...">
                    <form id="venueExportForm" method="POST" class="d-inline-flex flex-shrink-0">
                      @csrf
                      <button type="button" class="exp-btn" data-loading-text="Exporting..."
                        data-export-url="{{ route('venues.export.excel') }}">Export Excel</button>
                      <button type="button" class="exp-btn" data-loading-text="Exporting..."
                        data-export-url="{{ route('venues.export.pdf') }}">Export PDF</button>
                    </form>
                  </div>
                </div>
              </div>
              ...
              <div class="table-over">
                <table id="venuesTable" class="align-middle mb-0 table table-custom mt-3 w-100">
                  <thead>
                    <tr>
                      <th>
                        <input type="checkbox" id="selectAllVenues">
                      </th>
                      <th>SL No</th>
                      <th>Code</th>
                      <th>Venue Name</th>
